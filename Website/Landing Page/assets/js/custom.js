...
function send_form(){
	...
	if (first_name == "") {
		...
		$("input#first_name").attr("placeholder", "Name is must required..");
		return false;
	}
	//Contact number
	var contact_no = $("input#contact_no").val();
		...
		$("input#contact_no").attr("placeholder", "Contact number is must required..");
		return false;
	}
	else
	{
		if(isNaN(contact_no))
		{
			...
			$("input#contact_no").attr("placeholder", "Phone number must in digit");
			return false;
		}
	}
	//Email
	...
	var message = $("input#contact_message").val();
		...
		$("input#contact_message").attr("placeholder", "Message field is required");
		return false;
	}
	//Datastring pass to mail.php
	var dataString = '&Name=' + first_name + '&contact_no=' + contact_no + '&email=' + email + '&message=' + message;
	var form = $(this);
	var str = form.serialize(); 
	$.ajax({
